<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      <img class="content-image" :src="`https://kuangjing.oss-cn-beijing.aliyuncs.com/${shoplistone.logo}`">
      <div class="header-content">
        <h2 class="content-title">
          <span class="content-tag">
            <span class="mini-tag">品牌</span>
          </span>
          <span class="content-name">{{ shoplistone.name }}</span>
