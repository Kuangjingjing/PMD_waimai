      ...
      <div class="foods-wrapper">
        <ul ref="foodsUl">
          <li class="food-list-hook">
            ...
            <ul>
              <li class="food-item bottom-border-1px" v-for="(item, index) in getfoods" :key="index">
                <div class="icon">
                  <img width="57" height="57" v-lazy="`https://kuangjing.oss-cn-beijing.aliyuncs.com/${item.foodpic}`">
                </div>
                <div class="content">
